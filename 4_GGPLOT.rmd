...
# we can take our graphing object p and add the kind of graph we want, in this case we want the data represented as points (also called a scatterpoint)
p + geom_point()
...
p + scale_color_manual(values=mypalette)
